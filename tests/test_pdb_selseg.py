...
# class TestTool(unittest.TestCase):
    ...
    # def test_valid_1(self):
        # """pdb_selseg - sels chain A"""
        
        # input_file = os.path.join(data_dir, 'full_example.pdb')
        # output_file = os.path.join(output_dir, 'output_pdb_selseg_1.pdb')
    ...
    # def test_valid_2(self):
        # """
        # pdb_selseg - sels chain G
        # """
        
        # input_file = os.path.join(data_dir, 'full_example.pdb')
        # output_file = os.path.join(output_dir, 'output_pdb_selseg_2.pdb')
    ...
    # def test_InvalidOptionValue_2(self):
        # """pdb_selseg - argument is not an option"""
