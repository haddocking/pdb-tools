...
class TestTool(unittest.TestCase):
    ...
    def test_InvalidOptionValue(self):
        ...
        self.assertEqual(len(self.stdout), 0)  # no output
        self.assertEqual(self.stderr[0][:51], "ERROR!! You provided an invalid residue number: 'A'")
    
    def test_NotOptionValue(self):
        """
        pdb_reres - not an option
        """
        ...
        self.assertEqual(self.retcode, 1)
        self.assertEqual(len(self.stdout), 0)  # no output
        self.assertEqual(self.stderr[0], "ERROR! First argument is not an option: '1'")
